...
public class Manager {
    ...
    static final String valueHex = "0123456789ABCDEF";

    static String convertValue(String valueInput, int baseInput, int baseOutput) {
        String result = "";
        switch (baseInput) {
    ...
    static private String convertBinToOther(String valueInput, int baseOutput) {
        BigInteger numberIn = new BigInteger(valueInput);
        BigInteger inputBase = new BigInteger("2");
        BigInteger outputBase = new BigInteger(Integer.toString(baseOutput));
        String result = "";
        switch (baseOutput) {
            //covert Bin to decimal
            case 10:
    ...
    static private String convertHexToOther(String valueInput, int baseOutput) {
